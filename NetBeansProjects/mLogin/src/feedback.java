...
public class feedback extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("We would love to hear from you!!!");
        ...
        jLabel8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/sal8.jpg"))); // NOI18N

        submit_btn.setFont(new java.awt.Font("Aharoni", 1, 14)); // NOI18N
    ...
    private void submit_btnMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_submit_btnMouseClicked
            ...
            try
        {
            ...
            String opi=jTextArea1.getText();
            if(nm.isEmpty()||email.isEmpty()||address.isEmpty()||con.isEmpty()||opi.isEmpty()||!email.contains("@")||!email.contains(".com"))
            {
                JOptionPane.showMessageDialog(this,"Please fill every field","ERROR",JOptionPane.ERROR_MESSAGE); 
            }
            else
            {
                ...
                PreparedStatement st=(PreparedStatement) connection.prepareStatement("insert into feedback values(?,?,?,?,?)");
                ...
                st.executeUpdate();
                connection.close();
                JOptionPane.showMessageDialog(this,"Complaint has been Registered","Complain",JOptionPane.INFORMATION_MESSAGE);
