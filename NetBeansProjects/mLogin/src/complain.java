...
try
{
    ...
    //if(email.equals("")|| email.equals(" ")||!email.contains("@")||com.equals("")||com.equals(" "))
    if(email.isEmpty()|| com.isEmpty()||!email.contains("@")|| !email.contains(".com"))    
    {
        JOptionPane.showMessageDialog(this,"Either inavlid EMAIL address\nor complaint box is empty","ERROR 404!",JOptionPane.ERROR_MESSAGE); 
    }
    else
    {
        ...
        st.executeUpdate();
        connection.close();
        JOptionPane.showMessageDialog(this,"Your Complaint has been Registered","Complaint",JOptionPane.INFORMATION_MESSAGE); 
