...
try
{
    ...
    if(mail.isEmpty()|| id.isEmpty()||!mail.contains("@")||!mail.contains(".com")||name.isEmpty()|| password.isEmpty()|| gen.isEmpty())    
    {
        JOptionPane.showMessageDialog(this,"Please fill every box correctly","ERROR ",JOptionPane.ERROR_MESSAGE); 
    }
    ...
    else
    {
        ...
        change_db.execute();
        PreparedStatement st1=(PreparedStatement) connection.prepareStatement("select id from operator where id=?");
        st1.setString(1, id);
        ResultSet rs1=st1.executeQuery();
        if(rs1.next())
        {
            JOptionPane.showMessageDialog(this,"The user ID already exists","ERROR ",JOptionPane.ERROR_MESSAGE); 
        }
        else
        {
            PreparedStatement st=(PreparedStatement) connection.prepareStatement("insert into operator values(?,?,?,?,?)");
            st.setString(1,id);
            st.setString(2,name);
            ...
            st.executeUpdate();
            connection.close();
            JOptionPane.showMessageDialog(this,"New account has been created\n succesfully","Sucess",JOptionPane.INFORMATION_MESSAGE);
